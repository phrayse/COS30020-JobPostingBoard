    ...
    <h1>Job Vacancy Posting System</h1>
		<form id="jobPostForm" method="post" action="postjobprocess.php">
			<fieldset>
				...
				<p><label>Position ID:
					<input id="posID" type="text" name="posID" pattern="/^[P]\d\d\d\d$/"/>
				</label></p>
				...
				<p>Application by:
					<label><input id="postal" type="checkbox" name="applicationType" value="postal" />Post</label>
					<label><input id="email" type="checkbox" name="applicationType" value="email" />Email</label>
				</p>
